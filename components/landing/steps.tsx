        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <span className="inline-block py-1 px-3 rounded-full bg-pink-50 text-[#FD5D68] text-xs font-bold tracking-wider mb-4 uppercase">
                        How it works
                    </span>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="relative p-8 rounded-3xl border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 bg-white group">
                            <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center mb-6 group-hover:bg-[#FD5D68]/10 transition-colors">
                                <step.icon className="w-6 h-6 text-gray-900 group-hover:text-[#FD5D68] transition-colors" />
                            </div>
                            ...
                            <div className="absolute bottom-8 right-8 text-6xl font-serif font-bold text-gray-50 opacity-50 group-hover:text-[#FD5D68]/5 transition-colors select-none">
                                {step.number}
                            </div>
                        </div>
                    ))}
