...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen w-full flex bg-background">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-muted overflow-hidden items-center justify-center px-12">
                {/* Dynamic Background */}
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary rounded-full blur-[128px] opacity-20" />

                <div className="relative z-10 text-foreground max-w-lg">
                    <div className="w-12 h-12 bg-primary rounded-tl-xl rounded-br-xl transform rotate-45 mb-12" />
                    <h1 className="font-serif text-5xl font-bold leading-tight mb-6">
                        Find your person, <br />
                        <span className="text-primary italic">authentically.</span>
                    </h1>
